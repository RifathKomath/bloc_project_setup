...
// import 'package:easyfy_care_patient/features/booking_appointment_screen/data/datasource/book_appointment_data_source.dart';
// import 'package:easyfy_care_patient/features/booking_appointment_screen/data/repository/book_appointment_repository_impl.dart';
// import 'package:easyfy_care_patient/features/booking_appointment_screen/domain/repository/book_appointment_repo.dart';
...
//   // Data sources
//   getIt.registerLazySingleton<BookAppointmentDataSource>(
//     () => BookAppointmentDataSource(apiClient: getIt<ApiClient>()),
//   );

//   // Repositories
//   getIt.registerLazySingleton<BookAppointmentRepository>(
//     () => BookAppointmentRepositoryImpl(
//         datasource: getIt<BookAppointmentDataSource>()),
//   );

//   // Use cases
//   getIt.registerLazySingleton<BookAppointmentUsecases>(
//     () =>
//         BookAppointmentUsecases(repository: getIt<BookAppointmentRepository>()),
//   );

//   // BLoCs
//   getIt.registerFactory<AppointmentBloc>(
//     () => AppointmentBloc(
//         usecases: BookAppointmentUsecases(
//             repository: getIt<BookAppointmentRepository>())),
//   );
